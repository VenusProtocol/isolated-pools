...
* Merge pull request #538 from VenusProtocol/main ([83f9fee](https://github.com/VenusProtocol/isolated-pools/commit/83f9fee)), closes [#538](https://github.com/VenusProtocol/isolated-pools/issues/538)
* Merge pull request #539 from VenusProtocol/release/back ([fea7d99](https://github.com/VenusProtocol/isolated-pools/commit/fea7d99)), closes [#539](https://github.com/VenusProtocol/isolated-pools/issues/539)
* Merge pull request #540 from VenusProtocol/feat/ven-3326 ([00ba417](https://github.com/VenusProtocol/isolated-pools/commit/00ba417)), closes [#540](https://github.com/VenusProtocol/isolated-pools/issues/540)
* Merge pull request #542 from VenusProtocol/release/20250929 ([fc01896](https://github.com/VenusProtocol/isolated-pools/commit/fc01896)), closes [#542](https://github.com/VenusProtocol/isolated-pools/issues/542)
...
* Merge pull request #545 from VenusProtocol/fix/etherscan-verification ([045b20f](https://github.com/VenusProtocol/isolated-pools/commit/045b20f)), closes [#545](https://github.com/VenusProtocol/isolated-pools/issues/545)
...
* Merge pull request #556 from VenusProtocol/develop ([910ca45](https://github.com/VenusProtocol/isolated-pools/commit/910ca45)), closes [#556](https://github.com/VenusProtocol/isolated-pools/issues/556)
* chore: fix CI/release ([1c9f2b3](https://github.com/VenusProtocol/isolated-pools/commit/1c9f2b3))
* chore: update dependencies ([42d0d22](https://github.com/VenusProtocol/isolated-pools/commit/42d0d22))
* chore: update VToken deployment artifacts for basemainnet and opmainnet ([8d8c43b](https://github.com/VenusProtocol/isolated-pools/commit/8d8c43b))
* chore: update yarn.lock ([9d8ba8b](https://github.com/VenusProtocol/isolated-pools/commit/9d8ba8b))
* chore(release): 4.4.0-dev.1 [skip ci] ([58b76f8](https://github.com/VenusProtocol/isolated-pools/commit/58b76f8))
* chore(release): 4.4.0-dev.2 [skip ci] ([d9e6df7](https://github.com/VenusProtocol/isolated-pools/commit/d9e6df7))
* chore(release): 4.4.0-dev.3 [skip ci] ([f87d057](https://github.com/VenusProtocol/isolated-pools/commit/f87d057))
* chore(release): 4.4.0-dev.4 [skip ci] ([5d7ef4f](https://github.com/VenusProtocol/isolated-pools/commit/5d7ef4f))
* chore(release): 4.4.0-dev.5 [skip ci] ([3cf94df](https://github.com/VenusProtocol/isolated-pools/commit/3cf94df))
* chore(release): 4.4.0-dev.6 [skip ci] ([3a5afbc](https://github.com/VenusProtocol/isolated-pools/commit/3a5afbc))
* chore(release): 4.4.0-dev.7 [skip ci] ([cdc9185](https://github.com/VenusProtocol/isolated-pools/commit/cdc9185))
* docs: add README for exchange rate manipulation tests ([08e37fc](https://github.com/VenusProtocol/isolated-pools/commit/08e37fc))
* docs(audits): add CertiK and VBep20 donation patch audit reports ([c0def4c](https://github.com/VenusProtocol/isolated-pools/commit/c0def4c))
* fix: add repo URL ([6cd35fb](https://github.com/VenusProtocol/isolated-pools/commit/6cd35fb))
* fix: added patch ([2aebca2](https://github.com/VenusProtocol/isolated-pools/commit/2aebca2))
* fix: fix provider.init ([e00cafe](https://github.com/VenusProtocol/isolated-pools/commit/e00cafe))
* fix: fixed hardhat version ([8b2a199](https://github.com/VenusProtocol/isolated-pools/commit/8b2a199))
* fix: fixed provider.init ([4f728f0](https://github.com/VenusProtocol/isolated-pools/commit/4f728f0))
* fix: fixed solidity utilities version ([cde43f4](https://github.com/VenusProtocol/isolated-pools/commit/cde43f4))
* fix: fixed tests ([5d70112](https://github.com/VenusProtocol/isolated-pools/commit/5d70112))
* fix: fixed tests ([b542456](https://github.com/VenusProtocol/isolated-pools/commit/b542456))
* fix: lint ([a33f72e](https://github.com/VenusProtocol/isolated-pools/commit/a33f72e))
* fix: lint error ([f06a387](https://github.com/VenusProtocol/isolated-pools/commit/f06a387))
* fix: remove quote ([7391a52](https://github.com/VenusProtocol/isolated-pools/commit/7391a52))
* fix: removed berachain deployment ([6495a14](https://github.com/VenusProtocol/isolated-pools/commit/6495a14))
* fix: removed evm version ([642dfea](https://github.com/VenusProtocol/isolated-pools/commit/642dfea))
* fix: revert evm version ([3d40136](https://github.com/VenusProtocol/isolated-pools/commit/3d40136))
* fix: tests ([1dd43d8](https://github.com/VenusProtocol/isolated-pools/commit/1dd43d8))
* fix: update internalCash docs, README commands, and test assertions ([2882bc5](https://github.com/VenusProtocol/isolated-pools/commit/2882bc5))
* fix: update internalCash when bad debt is recovered ([a48ea61](https://github.com/VenusProtocol/isolated-pools/commit/a48ea61))
* fix: updated evm version ([6253248](https://github.com/VenusProtocol/isolated-pools/commit/6253248))
* fix: use blocksPerYear map to detect time-based networks in getMaxBorrowRateMantissa ([1022c8b](https://github.com/VenusProtocol/isolated-pools/commit/1022c8b))
* fix: use hardhat verify ([a91e873](https://github.com/VenusProtocol/isolated-pools/commit/a91e873))
...
* feat: add market upgrade deployment script and Base verification support ([b9571ef](https://github.com/VenusProtocol/isolated-pools/commit/b9571ef))
...
* feat: deploy new VToken implementation on arbitrumone ([b6b3100](https://github.com/VenusProtocol/isolated-pools/commit/b6b3100))
* feat: deploy new VToken implementation on basemainnet ([d342524](https://github.com/VenusProtocol/isolated-pools/commit/d342524))
* feat: deploy new VToken implementation on ethereum ([eb5011c](https://github.com/VenusProtocol/isolated-pools/commit/eb5011c))
* feat: deploy new VToken implementation on opbnbmainnet ([2cec2ef](https://github.com/VenusProtocol/isolated-pools/commit/2cec2ef))
* feat: deploy new VToken implementation on opmainnet ([aaf7147](https://github.com/VenusProtocol/isolated-pools/commit/aaf7147))
* feat: deploy new VToken implementation on unichainmainnet ([ad09919](https://github.com/VenusProtocol/isolated-pools/commit/ad09919))
* feat: deploy new VToken implementation on zksyncmainnet ([78d37ae](https://github.com/VenusProtocol/isolated-pools/commit/78d37ae))
* feat: enhance donation attack fork and unit test coverage ([7d8eef7](https://github.com/VenusProtocol/isolated-pools/commit/7d8eef7))
...
* feat: updating deployment files ([e8b2def](https://github.com/VenusProtocol/isolated-pools/commit/e8b2def))
* feat: updating deployment files ([28e373b](https://github.com/VenusProtocol/isolated-pools/commit/28e373b))
* feat: updating deployment files ([8c1bf95](https://github.com/VenusProtocol/isolated-pools/commit/8c1bf95))
* feat: updating deployment files ([19c1ac9](https://github.com/VenusProtocol/isolated-pools/commit/19c1ac9))
...
* feat: updating deployment files ([966018c](https://github.com/VenusProtocol/isolated-pools/commit/966018c))
* feat(deploy): auto-verify VToken implementation after deployment ([d3edc6a](https://github.com/VenusProtocol/isolated-pools/commit/d3edc6a))
* feat(VToken): add internalCash to prevent donation attack ([9cd1c59](https://github.com/VenusProtocol/isolated-pools/commit/9cd1c59))
* refactor: refactor donation attack and storage check fork tests ([ef343da](https://github.com/VenusProtocol/isolated-pools/commit/ef343da))
* refactor: remove check_markets script ([0460f3b](https://github.com/VenusProtocol/isolated-pools/commit/0460f3b))
* refactor: update NatSpec comments ([5dca00b](https://github.com/VenusProtocol/isolated-pools/commit/5dca00b))
