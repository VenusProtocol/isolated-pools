...
export const contractAddresses = {
  sepolia: {
    ...
    CORE_COMPTROLLER: SepoliaContracts.Comptroller_Core.address,
  ...
  ethereum: {
    ...
    CORE_COMPTROLLER: EthereumContracts.Comptroller_Core.address,
  ...
  opbnbtestnet: {
    ...
    CORE_COMPTROLLER: OpBnbTestnetContracts.Comptroller_Core.address,
  ...
  opbnbmainnet: {
    ...
    CORE_COMPTROLLER: OpBnbMainnetContracts.Comptroller_Core.address,
  ...
  arbitrumsepolia: {
    ...
    CORE_COMPTROLLER: ArbSepContracts.Comptroller_Core.address,
  ...
  arbitrumone: {
    ...
    CORE_COMPTROLLER: ArbOneContracts.Comptroller_Core.address,
