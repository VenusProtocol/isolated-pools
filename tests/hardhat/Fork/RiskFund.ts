...
describe("Risk Fund: Tests", function () {
  ...
  describe("Test all setters", async function () {
    ...
    describe("swapPoolsAssets", async function () {
      ...
      it("fails if start path is not market", async function () {
        ...
        await cUSDC.reduceReserves(convertToUnit(100, 18), 0);
  ...
  describe("Risk fund transfers", async function () {
    ...
    it("Below min threshold amount", async function () {
      await USDC.connect(usdcUser).approve(cUSDC.address, convertToUnit(1000, 18));
      await cUSDC.connect(usdcUser).addReserves(convertToUnit(100, 18));
      await cUSDC.reduceReserves(convertToUnit(50, 18), 0);
      ...
      await protocolShareReserve.releaseFunds(comptroller1Proxy.address, USDC.address, convertToUnit(30, 18), 0);
    ...
    it("Add two assets to riskFund", async function () {
      ...
      await cUSDT.reduceReserves(convertToUnit(100, 18), 0);
      ...
      await protocolShareReserve.releaseFunds(comptroller1Proxy.address, USDC.address, convertToUnit(100, 18), 0);
      await protocolShareReserve.releaseFunds(comptroller1Proxy.address, USDT.address, convertToUnit(100, 18), 0);
      const riskFundUSDCBal = await USDC.balanceOf(riskFund.address);
      expect(riskFundUSDCBal).equal(convertToUnit(30, 18));
  ...
  describe("Transfer to Auction contract", async function () {
    ...
    it("Transfer single asset from multiple pools to riskFund", async function () {
      ...
      await cUSDT.reduceReserves(convertToUnit(110, 18), 0);
      await cUSDC.reduceReserves(convertToUnit(120, 18), 0);
      await cUSDT2.reduceReserves(convertToUnit(150, 18), 0);
      await cUSDC2.reduceReserves(convertToUnit(160, 18), 0);
      await cUSDT3.reduceReserves(convertToUnit(175, 18), 0);
      await bUSDT3.reduceReserves(convertToUnit(50, 18), 0);
      ...
      await protocolShareReserve.releaseFunds(comptroller2Proxy.address, USDT.address, convertToUnit(110, 18), 0);

      await protocolShareReserve.releaseFunds(comptroller3Proxy.address, USDT.address, convertToUnit(130, 18), 0);

      await protocolShareReserve.releaseFunds(comptroller1Proxy.address, USDC.address, convertToUnit(90, 18), 0);

      await protocolShareReserve.releaseFunds(comptroller2Proxy.address, USDC.address, convertToUnit(80, 18), 0);

      await protocolShareReserve.releaseFunds(comptroller3Proxy.address, BUSD.address, convertToUnit(50, 18), 0);
