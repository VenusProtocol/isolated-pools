    ...
    poolConfig: [
      {
        ...
        vtokens: [
          ...
          },
          {
            ...
            baseRatePerYear2: "0",
            multiplierPerYear: convertToUnit("0.1", 18),
            multiplierPerYear2: convertToUnit("0.7", 18),
            jumpMultiplierPerYear: convertToUnit("0.8", 18),
            kink_: convertToUnit("0.8", 18),
    ...
    poolConfig: [
      {
        ...
        vtokens: [
          ...
          },
          {
            ...
            baseRatePerYear: "0",
            baseRatePerYear2: "0",
            multiplierPerYear: convertToUnit("0.10", 18),
            multiplierPerYear2: convertToUnit("0.7", 18),
    ...
    poolConfig: [
      {
        ...
        vtokens: [
          ...
          },
          {
            ...
            liquidationThreshold: convertToUnit("0.8", 18),
            reserveFactor: convertToUnit("0.2", 18),
            initialSupply: convertToUnit("0.00100364", 8),
            supplyCap: convertToUnit("400", 8),
            borrowCap: convertToUnit("40", 8),
            reduceReservesBlockDelta: REDUCE_RESERVES_BLOCK_DELTA_UNICHAIN_SEPOLIA,
            vTokenReceiver: preconfiguredAddresses.unichainsepolia.VTreasury,
          },
          {
            ...
            liquidationThreshold: convertToUnit("0.8", 18),
            reserveFactor: convertToUnit("0.1", 18),
            initialSupply: convertToUnit("102.84258", 6),
            supplyCap: convertToUnit(50_000_000, 6),
            borrowCap: convertToUnit(45_000_000, 6),
            reduceReservesBlockDelta: REDUCE_RESERVES_BLOCK_DELTA_UNICHAIN_SEPOLIA,
            vTokenReceiver: preconfiguredAddresses.unichainsepolia.VTreasury,
...
export function getMaxBorrowRateMantissa(networkName: string): BigNumber {
  const isTimeBased =
    blocksPerYear[networkName] === "time-based" || process.env.IS_TIME_BASED_DEPLOYMENT === "true";
