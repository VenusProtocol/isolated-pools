        ...
        rewards: [
          {
            asset: "XVS",
            markets: ["BNX", "WBNB"],
            supplySpeeds: [convertToUnit(23, 8), convertToUnit(24, 8)],
            borrowSpeeds: [convertToUnit(23, 8), convertToUnit(24, 8)],
          },
          {
            asset: "BNX",
            markets: ["BNX"],
        ...
        rewards: [
          {
            ...
            markets: ["CAKE", "WBTC"],
            supplySpeeds: [convertToUnit(23, 8), convertToUnit(24, 8)],
            borrowSpeeds: [convertToUnit(24, 8), convertToUnit(25, 8)],
          },
          {
            asset: "CAKE",
            markets: ["CAKE"],
